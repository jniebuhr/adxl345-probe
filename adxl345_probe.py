...
OFS_SCALE = 0.0156 * adxl345.FREEFALL_ACCEL  # 15.6mg/LSB * Earth gravity in mm/s**2
...
class ADXL345Probe:
    def __init__(self, config):
        ...
        gcode.register_mux_command("SET_ACCEL_PROBE", "CHIP", None, self.cmd_SET_ACCEL_PROBE, desc=self.cmd_SET_ACCEL_PROBE_help)
    ...
    def probe_prepare(self, hmove):
        ...
        clock = self.adxl345.mcu.print_time_to_clock(print_time + ADXL345_REST_TIME)
